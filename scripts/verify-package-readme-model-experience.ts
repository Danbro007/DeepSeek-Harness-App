...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-usage': { kind: 'none', reason: 'Browser-side settings page; the host usage service and tool own any model-visible effect.' },
  ...
  'packages/usage/usage-deepseek': { kind: 'indirect', reason: 'The read service delegates model rendering to dsh-tool-usage.' },
