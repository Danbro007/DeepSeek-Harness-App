...
import usageRemote from '@deepseek-ai/dsh-usage-deepseek/remote'
...
export type {} from '@deepseek-ai/dsh-usage-deepseek/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      pluginInventoryRemote, messageFeedbackRemote, sessionReferencesRemote, usageRemote,
    ]) {
